...
> 一套基于 Obsidian-Brain-OS git 驱动持久化设计的 Hermes 技能体系，实现 Agent 的 git 驱动知识管理。
...
灵感来源于 [Obsidian-Brain-OS](https://github.com/FairladyZ625/Obsidian-Brain-OS) 的 git 驱动持久化设计：
